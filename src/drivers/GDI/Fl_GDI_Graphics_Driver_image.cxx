...
static void draw_scaled_gdi_img(Gdiplus::Bitmap *gdi_img, int x, int y, int w, int h, Gdiplus::REAL s, Gdiplus::Graphics *g) {
  int X = Fl_GDIplus_Graphics_Driver::floor(x, s), Y = Fl_GDIplus_Graphics_Driver::floor(y, s),
    W = Fl_GDIplus_Graphics_Driver::floor(x+w, s) - X, H = Fl_GDIplus_Graphics_Driver::floor(y+h, s) - Y;
